    ...
    <div id="view-ordens" className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#E51D24] hover:bg-[#C81018] text-white text-[13px] font-bold uppercase tracking-wider rounded-lg transition-all shadow-[0_0_14px_rgba(229,29,36,0.35)] cursor-pointer self-start sm:self-auto"
        >
                        ...
                        >
                          ...
                          {whatsappLink && (
                            <a
                              ...
                              className="inline-flex items-center gap-1 text-xs font-bold px-2.5 py-1.5 rounded-md bg-[#25D366]/15 hover:bg-[#25D366]/25 text-[#25D366] border border-[#25D366]/35 transition-colors cursor-pointer"
